      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        <div className="mb-8 flex items-center justify-center gap-4 sm:gap-8">
          ...
          <div className="flex flex-col items-center gap-2">
            <div className="h-12 w-12 sm:h-14 sm:w-14 rounded-lg bg-secondary flex items-center justify-center shadow-sm">
              <span className="text-lg sm:text-xl font-bold text-white">1</span>
            </div>
            <span className="text-xs sm:text-sm font-medium text-foreground text-center max-w-[75px] leading-tight">AWS Student<br/>Community</span>
          </div>
          
          {/* AWS Cloud Club */}
          <div className="flex flex-col items-center gap-2">
            <div className="h-12 w-12 sm:h-14 sm:w-14 rounded-lg bg-accent flex items-center justify-center shadow-sm">
              <span className="text-lg sm:text-xl font-bold text-white">2</span>
            </div>
            <span className="text-xs sm:text-sm font-medium text-foreground text-center max-w-[75px] leading-tight">AWS Cloud<br/>Club</span>
          </div>
          
          {/* Amity University Bengaluru */}
          <div className="flex flex-col items-center gap-2">
            <div className="h-12 w-12 sm:h-14 sm:w-14 rounded-lg bg-primary flex items-center justify-center shadow-sm">
              <span className="text-lg sm:text-xl font-bold text-white">3</span>
            </div>
            <span className="text-xs sm:text-sm font-medium text-foreground text-center max-w-[75px] leading-tight">Amity<br/>University</span>
          </div>
        </div>

        {/* Event name */}
        <h1 className="font-display text-4xl font-bold leading-tight tracking-tight text-foreground sm:text-6xl lg:text-7xl">
          <span className="block">AW Student</span>
