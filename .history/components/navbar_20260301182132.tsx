      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6">
        ...
        <div className="hidden md:block">
          <a
            ...
            className="inline-flex items-center rounded-full bg-primary px-5 py-2 text-sm font-semibold text-primary-foreground transition-all hover:shadow-[0_0_20px_hsl(265_80%_65%/0.4)]"
          >
            Register Now
          </a>
        </div>
