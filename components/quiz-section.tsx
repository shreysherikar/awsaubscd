...
const badges = [
  { min: 0, label: "Beginner", color: "hsl(217 92% 51%)", icon: "🌱" },
  { min: 2, label: "Intermediate", color: "hsl(186 100% 50%)", icon: "📈" },
  { min: 4, label: "Advanced", color: "hsl(250 70% 63%)", icon: "⭐" },
  { min: 5, label: "Expert", color: "hsl(40 80% 60%)", icon: "👑" },
]
          ...
          {!started ? (
            <div className="glass rounded-2xl p-8 text-center">
              ...
              <button
                ...
                className="mt-6 inline-flex items-center gap-2 rounded-full bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground transition-all hover:shadow-[0_0_20px_hsl(265_80%_65%/0.4)]"
              >
                Start Quiz
            ...
            <div className="glass rounded-2xl p-8">
                ...
                {questions[currentQ].options.map((option, i) => {
                  ...
                  if (answered) {
                    if (i === questions[currentQ].correct) {
                      optionStyle = "bg-emerald-500/20 text-emerald-400 border-emerald-500/30"
                    } else if (i === selected && i !== questions[currentQ].correct) {
                      optionStyle = "bg-red-500/20 text-red-400 border-red-500/30"
                    } else {
              ...
              {answered && (
                <div className="mt-6 flex justify-end">
                  <button
                    onClick={handleNext}
                    className="inline-flex items-center gap-2 rounded-full bg-primary px-5 py-2 text-sm font-semibold text-primary-foreground transition-all hover:shadow-[0_0_20px_hsl(265_80%_65%/0.4)]"
                  >
