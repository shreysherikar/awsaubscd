      ...
      <div ref={ref} className="mx-auto max-w-7xl px-6">
        ...
        <div className={`mt-12 grid gap-8 lg:grid-cols-3 transition-all duration-700 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`} style={{ animationDelay: "200ms" }}>
          ...
          <div className="lg:col-span-2 overflow-hidden rounded-2xl border border-border/50">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.965969058786!2d77.6834!3d12.8981!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae15b0!2sAmity%20University%20Bengaluru!5e0!3m2!1sen!2sin!4v1700000000000!5m2!1sen!2sin"
              width="100%"
              height="400"
              style={{ border: 0 }}
              allowFullScreen
