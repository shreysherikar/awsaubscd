...
const speakers = [
  ...
  },
  {
    ...
    company: "Freshworks",
    session: "Zero-Downtime Deployments with AWS",
    bio: "Pioneering SRE practices and CI/CD pipelines that enable 100+ daily deployments across global infrastructure.",
  ...
  },
  {
    ...
    company: "Paytm",
    session: "Cloud Security for Fintech",
    bio: "Specializing in compliance-driven cloud security architectures for financial platforms serving millions.",
  ...
  },
  {
    ...
    company: "Independent",
    session: "From Student to Cloud Professional",
    bio: "AWS Community Hero and educator, helping thousands of students launch their cloud careers through hands-on learning.",
